...
<body>
	<div class="w3-content mxw650">
	 	<h1 class="w3-center w3-amber w3-padding">Join Page</h1>
		    ...
		    class="w3-gray w3-center w3-margin-top w3-card-4">
		        ...
		        <div class="w3-btn w3-center w3-brown w3-margin-top w3-margin-bottom" id="join">정보등록</div>
		    </form>
	</div>
</body>
</html>
