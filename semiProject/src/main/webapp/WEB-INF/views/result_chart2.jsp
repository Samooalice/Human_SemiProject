    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#chart3').click(function() {
                $('#fullchart iframe').attr('src', 'http://58.72.151.124:6002/tm/showChart3.tm/');
                $('#fullchart').show();
            });

            $('#chart5').click(function() {
                $('#fullchart iframe').attr('src', 'http://58.72.151.124:6002/tm/showChart5.tm/');
                $('#fullchart').show();
            });
